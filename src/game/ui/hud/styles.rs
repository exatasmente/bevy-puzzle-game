...
pub fn lives_pip_style() -> Node {
    Node {
    width: Val::Px(LIVES_PIP_SIZE),
    height: Val::Px(LIVES_PIP_SIZE),
    min_width: Val::Px(LIVES_PIP_SIZE),
    min_height: Val::Px(LIVES_PIP_SIZE),
    margin: UiRect {
...
pub fn icon_button_style() -> Node {
    ...
    min_width: Val::Px(theme::TOUCH_TARGET),
