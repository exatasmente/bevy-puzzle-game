...
pub const HUD_ROOT_STYLE: Node = Node {
...
pub const HUD_PANEL_STYLE: Node = Node {
...
pub const TOP_BAR_STYLE: Node = Node {
...
pub const STAT_STYLE: Node = Node {
    flex_direction: FlexDirection::Column,
    justify_content: JustifyContent::Center,
    align_items: AlignItems::Center,
    flex_grow: 1.0,
...
pub const LEVEL_ROW_STYLE: Node = Node {
...
pub const LIVES_ROW_STYLE: Node = Node {
    flex_direction: FlexDirection::Row,
    align_items: AlignItems::Center,
    ..Node::DEFAULT
};
...
pub const LIVES_PIP_STYLE: Node = Node {
...
pub const ICON_BUTTON_STYLE: Node = Node {
...
pub const BACK_BUTTON_ROOT_STYLE: Node = Node {
    position_type: PositionType::Absolute,
    size: Size::new(Val::Percent(100.0), Val::Percent(100.0)),
    flex_direction: FlexDirection::Column,
